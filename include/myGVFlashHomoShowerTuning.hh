...
//---------------------------------------------------------------
#ifndef myGVFlashHomoShowerTuning_hh
#define myGVFlashHomoShowerTuning_hh

#include "G4Types.hh"
#include "G4String.hh"

class myGVFlashHomoShowerTuning
{
  public:
    myGVFlashHomoShowerTuning() {}
  myGVFlashHomoShowerTuning(const G4String& aName);
  virtual ~myGVFlashHomoShowerTuning() {}
  void readParameters(const G4String& aName);
  void printParameters() const;
  public: // with description

  virtual G4double ParAveT1(){ return fParAveT1;} // t1
    ...
    virtual G4double ParSigLogA1(){ return fParSigLogA1;} // a1
    virtual G4double ParSigLogA2(){ return fParSigLogA2; } // a2
      // std::sqrt(var(ln(alpha))) = 1/(a1+a2*ln(y))
  
    virtual G4double ParRho1(){ return fParRho1; } // r1
    virtual G4double ParRho2(){ return fParRho2;} // r2
...
private:
  ...
  float fParSigLogA1 = -0.58; // a1
  float fParSigLogA2 = 0.86; // a2

  float fParRho1 = 0.705;  // r1
  float fParRho2 = -0.023; // r2
private:
