...
//---------------------------------------------------------------
#ifndef myGFlashHitMaker_h
#define myGFlashHitMaker_h 1
...
class myGFlashHitMaker : public GFlashHitMaker
{
  public:
  ...
  inline void SetUseSDOfEnvelopeWorld(G4bool aFlag) {fUseSDOfEnvelopeWorld = aFlag; return;};
