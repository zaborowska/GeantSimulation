...
#ifndef myG4FastSimulationPhysics_h
#define myG4FastSimulationPhysics_h 1
...
class myG4FastSimulationPhysics : public G4VPhysicsConstructor
{
public:
  
  myG4FastSimulationPhysics(const G4String& name = "FastSimP");
  virtual ~myG4FastSimulationPhysics();
...
private:
  ...
  myG4FastSimulationPhysics & operator=(const myG4FastSimulationPhysics &right);
  myG4FastSimulationPhysics(const myG4FastSimulationPhysics&);
