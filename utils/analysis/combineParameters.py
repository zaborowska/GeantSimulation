...
#    out_tex.write(r'''\begin{equation} f(t) = \frac{\left(\beta t\right)^{\alpha-1} \beta \exp^{-\beta t}}{\Gamma(\alpha)}~~~~~~ \left(T = \frac{\alpha - 1}{\beta}\right)\end{equation}''')
    ...
    out_tex.write(r'''\begin{equation}  \rho\left(\log T, \log\alpha \right)= ''' + str(round(longitudinal_params["singleLongProfileLogAlphaLogTRho_p1"],digits)) + ' \cdot \log y ' + ('+' if longitudinal_params["singleLongProfileLogAlphaLogTRho_p0"] > 0 else '') + str(round(longitudinal_params["singleLongProfileLogAlphaLogTRho_p0"],digits)) + '\label{eq:longProfileParamsAvg'+param+'}\end{equation}')

    for param in ["T", "Alpha"]:
        out_tex.write(r'''\begin{figure}\centering\includegraphics[height=0.3\textheight]{tex/'''+"avgLongProfile"+param+".pdf}\caption{"+r'''$''' + symbol[param] + r'''$ parameter extracted from Gamma fit, Eq.~(\ref{eq:longProfileAlphaT}), to the average longitudinal shower profile.'''+" Fitted function (red) is described by $" + symbol[param] + ' = (' + str(round(longitudinal_params["avgLongProfile"+param+"_p1"],digits)) + ' \pm ' + str(abs(round(longitudinal_params["avgLongProfile"+param+"_e1"],digits))) + ') \cdot \log y + (' + str(round(longitudinal_params["avgLongProfile"+param+"_p0"],digits)) + ' \pm '+ str(round(longitudinal_params["avgLongProfile"+param+"_e0"],digits)) + r''')$, Eq.~(\ref{eq:longProfileParamsAvg'''+param+"}). Original GFlash parameters are plotted in green for Z = "+str(int(Z))+": $"+symbol[param]+" = "+ str(round(original_params["avgLongProfile"+param+"_p1"],digits)) + ' \cdot \log y ' + ('+' if original_params["avgLongProfile"+param+"_p0"] > 0 else '') + str(round(original_params["avgLongProfile"+param+"_p0"],digits)) +"$.}\end{figure}")
    for param in ["T", "Alpha"]:
        out_tex.write(r'''\begin{figure}\centering\includegraphics[height=0.3\textheight]{tex/'''+"singleLongProfileLog"+param+"Mean.pdf}\caption{"+r'''Mean of the Gaussian distribution of $\log '''+symbol[param]+r'''$ parameter, extracted from Gamma fit, Eq.~(\ref{eq:longProfileAlphaT}), to the individual shower profiles.'''+" Fitted function (red) is described by $\langle\log " + symbol[param] + r''' \rangle = \log\left( (''' + str(round(longitudinal_params["singleLongProfileLog"+param+"Mean_p1"],digits)) + ' \pm ' + str(abs(round(longitudinal_params["singleLongProfileLog"+param+"Mean_e1"],digits))) + ') \cdot \log y + (' + str(round(longitudinal_params["singleLongProfileLog"+param+"Mean_p0"],digits)) + ' \pm '+ str(round(longitudinal_params["singleLongProfileLog"+param+"Mean_e0"],digits)) + r''')\right)$, Eq.~(\ref{eq:longProfileParamsSingleLog'''+param+r'''Mean}). Original GFlash parameters are plotted in green for Z = '''+str(int(Z))+": $\langle\log "+symbol[param]+r'''\rangle = \log \left( '''+ str(round(original_params["singleLongProfileLog"+param+"Mean_p1"],digits)) + ' \cdot \log y ' + ('+' if original_params["singleLongProfileLog"+param+"Mean_p0"] > 0 else '') + str(round(original_params["singleLongProfileLog"+param+"Mean_p0"],digits)) +r'''\right)$.}\end{figure}''')
        out_tex.write(r'''\begin{figure}\centering\includegraphics[height=0.3\textheight]{tex/'''+"singleLongProfileLog"+param+"Sigma.pdf}\caption{"+r'''Sigma of the Gaussian distribution of $\log '''+symbol[param]+r'''$ parameter, extracted from Gamma fit, Eq.~(\ref{eq:longProfileAlphaT}), to the individual shower profiles.'''+" Fitted function (red) is described by $\sigma\left(\log " + symbol[param] + r''' \right) = \left( (''' + str(round(longitudinal_params["singleLongProfileLog"+param+"Sigma_p1"],digits)) + ' \pm ' + str(abs(round(longitudinal_params["singleLongProfileLog"+param+"Sigma_e1"],digits))) + ') \cdot \log y + (' + str(round(longitudinal_params["singleLongProfileLog"+param+"Sigma_p0"],digits)) + ' \pm '+ str(round(longitudinal_params["singleLongProfileLog"+param+"Sigma_e0"],digits)) + r''')\right)^{-1}$, Eq.~(\ref{eq:longProfileParamsSingleLog'''+param+r'''Sigma}). Original GFlash parameters are plotted in green for Z = '''+str(int(Z))+": $\sigma\left(\log "+symbol[param]+r'''\right) = \left( '''+ str(round(original_params["singleLongProfileLog"+param+"Sigma_p1"],digits)) + ' \cdot \log y ' + ('+' if original_params["singleLongProfileLog"+param+"Sigma_p0"] > 0 else '') + str(round(original_params["singleLongProfileLog"+param+"Sigma_p0"],digits)) +r'''\right)^{-1}$.}\end{figure}''')
    out_tex.write(r'''\begin{figure}\centering\includegraphics[height=0.3\textheight]{tex/'''+"singleLongProfileLogAlphaLogTRho.pdf}\caption{"+r'''Correlation between $\log T$ and $\log\alpha$ parameters, extracted from Gamma fit, Eq.~(\ref{eq:longProfileAlphaT}), to the individual shower profiles.'''+r''' Fitted function (red) is described by $ \rho(\log T,\log\alpha)  = (''' + str(round(longitudinal_params["singleLongProfileLogAlphaLogTRho_p1"],digits)) + ' \pm ' + str(abs(round(longitudinal_params["singleLongProfileLogAlphaLogTRho_e1"],digits))) + ') \cdot \log y + (' + str(round(longitudinal_params["singleLongProfileLogAlphaLogTRho_p0"],digits)) + ' \pm '+ str(round(longitudinal_params["singleLongProfileLogAlphaLogTRho_e0"],digits)) + r''')$, Eq.~(\ref{eq:longProfileParamsSingleRho}). Original GFlash parameters are plotted in green for Z = '''+str(int(Z))+r''': $\rho(\log T, \log\alpha) = '''+ str(round(original_params["singleLongProfileLogAlphaLogTRho_p1"],digits)) + ' \cdot \log y ' + ('+' if original_params["singleLongProfileLogAlphaLogTRho_p0"] > 0 else '') + str(round(original_params["singleLongProfileLogAlphaLogTRho_p0"],digits)) +"$.}\end{figure}")
