...
{  
  ...
  G4cout << "/********************************************/ " << G4endl;
  G4cout << "  - myGFlashHomoShowerParameterisation::Constructor -  " << G4endl;  
  G4cout << "/********************************************/ " << G4endl;
}

void myGFlashHomoShowerParameterisation::SetMaterial(G4Material *mat)
{
  material= mat;
  Z = GetEffZ(material);
  A = GetEffA(material);
...
myGFlashHomoShowerParameterisation::~myGFlashHomoShowerParameterisation()
{
  if(owning) { delete thePar; }
}

void myGFlashHomoShowerParameterisation::
GenerateLongitudinalProfile(G4double Energy)
{
  if (material==0) 
  {
    G4Exception("myGFlashHomoShowerParameterisation::GenerateLongitudinalProfile()",
...
void myGFlashHomoShowerParameterisation::GenerateEnergyProfile(G4double /* y */)
{ 
