...
myGFlashShowerModel::myGFlashShowerModel(G4String modelName,
                                     G4Envelope* envelope)
...
G4bool myGFlashShowerModel::ModelTrigger(const G4FastTrack & fastTrack )
...
void
myGFlashShowerModel::DoIt(const G4FastTrack& fastTrack, G4FastStep& fastStep)
{
...
void
myGFlashShowerModel::ElectronDoIt(const G4FastTrack& fastTrack,
                                      G4FastStep&  fastStep)
{
