...
//---------------------------------------------------------------------------
//
// ClassName:   myG4FastSimulationPhysics
//
...
//
G4_DECLARE_PHYSCONSTR_FACTORY(myG4FastSimulationPhysics);

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

myG4FastSimulationPhysics::myG4FastSimulationPhysics(const G4String& name)
...
myG4FastSimulationPhysics::~myG4FastSimulationPhysics()
{;}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

void myG4FastSimulationPhysics::ActivateFastSimulation(const G4String& particleName)
{
...
void myG4FastSimulationPhysics::ActivateFastSimulation(const G4String& particleName, const G4String& parallelGeometryName)
{
  fParticlesUnderFastSimulation.push_back(particleName);
...
void myG4FastSimulationPhysics::ConstructParticle()
{;}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

void myG4FastSimulationPhysics::ConstructProcess()
{
  ...
  while ( (*myParticleIterator)() )
      ...
      if ( itr != fParticlesUnderFastSimulation.end() )
	{
	  ...
	  if ( geometry == "" ) myG4FastSimulationHelper::ActivateFastSimulation(pmanager);
	  else                  myG4FastSimulationHelper::ActivateFastSimulation(pmanager, geometry);
	}
    }
